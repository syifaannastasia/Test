...
<body>
    ...
    <div class="mn-content fixed-sidebar">
                    ...
                    <li class="no-padding active">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="<?php echo base_url('admin/pengadaan_barang_data_admin'); ?>" class="active-page">Data Pengadaan Barang</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding">
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">Data Pengadaan Barang</div>
                </div>
