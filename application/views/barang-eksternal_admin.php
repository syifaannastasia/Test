...
<body>
    ...
    <div class="mn-content fixed-sidebar">
                    ...
                    <li class="no-padding active">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="<?php echo base_url('admin/barang_eksternal_admin'); ?>" class="active-page">Barang Eksternal</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding">
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">Barang Eksternal</div>
                </div>
