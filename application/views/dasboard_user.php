        ...
        <aside id="slide-out" class="side-nav white fixed">
            <div class="side-nav-wrapper">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    <li class="no-padding active"><a class="waves-effect waves-grey active" href="index.html"><i class="material-icons" class="active-page">settings_input_svideo</i>Dashboard</a></li>
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="peminjaman-data.html"><i class="material-icons">dvr</i>Data Peminjaman</a></li>
                </ul>
            </div>
        </aside>
            ...
            <div class="middle-content">
                <div class="row no-m-t no-m-b">
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title">Data Approve</span>
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title">Data Decline</span>
                                ...
                                <table class="responsive-table bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="number">Nama Peminjam</th>
                                            <th data-field="progress">Tanggal Input</th>
