        ...
        <aside id="slide-out" class="side-nav white fixed">
            <div class="side-nav-wrapper">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    ...
                    <li class="no-padding active"><a class="waves-effect waves-grey active" href="peminjaman-barang.html"><i class="material-icons" class="active-page">note_add</i>Peminjaman Baru</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-reveal">
                        ...
                        <div class="row" style="margin-bottom: 0px;">
                          ...
                          <div class="col m6 s12 center">
                              <a href="detail-barang.html" class="waves-effect waves-blue btn-flat m-b-xs" style="margin-bottom: 0px;">Detail</a>
                          </div>
                      </div>
                  </div>
              </div>
